...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignCourses.aspx.cs" Inherits="_Default" %>
      ...
      <div class="home">
          ...
          <div id="PersonalInformation">
                ...
                <div class="title">
                     ...
                     <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ROLL NO
                         <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="Roll_No" DataValueField="Roll_No" AutoPostBack="true">
                         </asp:DropDownList>
&nbsp;</h2>
                     <h2>&nbsp;&nbsp;&nbsp;&nbsp; Semester&nbsp;
                         <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="SName" DataValueField="SName" AutoPostBack="true">
                         </asp:DropDownList>
                     &nbsp;
